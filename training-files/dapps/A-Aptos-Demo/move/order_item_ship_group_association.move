...
module aptos_test_proj1::order_item_ship_group_association {
    use aptos_std::table_with_length::{Self, TableWithLength};
    use aptos_test_proj1::day::Day;
    use aptos_test_proj1::order_item_ship_group_assoc_subitem::{Self, OrderItemShipGroupAssocSubitem};
    ...
    friend aptos_test_proj1::order_ship_group;
