...
module hwswap::swap_test {
    ...
    use hwswap::swap::{Self, LPToken, initialize};
    use hwswap::router;
    use hwswap::math;
    ...
    public fun setup_test(dev: &signer, admin: &signer, treasury: &signer, resource_account: &signer) {
        ...
        resource_account::create_resource_account(dev, b"hwswap", x"");
        initialize(resource_account);
        swap::set_fee_to(admin, signer::address_of(treasury))
    }

    #[test(dev = @dev, admin = @hwswap_admin, resource_account = @hwswap, treasury = @0x23456, bob = @0x12345, alice = @0x12346)]
    ...
    #[test(dev = @dev, admin = @hwswap_admin, resource_account = @hwswap, treasury = @0x23456, bob = @0x12341, alice = @0x12342)]
    ...
    #[test(dev = @dev, admin = @hwswap_admin, resource_account = @hwswap, treasury = @0x23456, user1 = @0x12341, user2 = @0x12342, user3 = @0x12343, user4 = @0x12344)]
    ...
    #[test(dev = @dev, admin = @hwswap_admin, resource_account = @hwswap, treasury = @0x23456, user1 = @0x12341, user2 = @0x12342, user3 = @0x12343, user4 = @0x12344, alice = @0x12345)]
